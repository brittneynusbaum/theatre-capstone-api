...
Note.create!([
  ...
  {description: "great song for LOTR musical - date 5/31/22", saved_song_id: 20, user_id: 1},
  {description: "great audition song for LOTR! date - 5/31/22", saved_song_id: 22, user_id: 1},
  {description: "great song for LOTR musical! date - 5/30/22", saved_song_id: 24, user_id: 1},
  {description: "great audition song for LOTR - date 5/30/22", saved_song_id: 26, user_id: 1},
  {description: "Great song for LOTR audition! - date 5/3-/22", saved_song_id: 26, user_id: 1},
  {description: "Great song for LOTR audition! date - 5/30/22", saved_song_id: 30, user_id: 1},
  {description: "great song for LOTR! date - 5/22/22", saved_song_id: 32, user_id: 1}
])
SavedSong.create!([
  {song_id: 1, user_id: 3},
  {song_id: 4, user_id: 3},
